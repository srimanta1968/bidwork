...
import { getCatalogs, createCatalog, getCatalogItems, addCatalogItem, updateCatalogItem, deleteCatalogItem, presignCatalogItemImage } from '../controllers/catalogController';
...
router.post('/items/:itemId/image/presign', authenticate, wrap(presignCatalogItemImage));
