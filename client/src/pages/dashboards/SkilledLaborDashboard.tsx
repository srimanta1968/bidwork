...
export default function SkilledLaborDashboard() {
  ...
  const stats = [
    { label: 'Available Gigs', value: '0', icon: '📋' },
    { label: 'My Applications', value: '0', icon: '📨' },
    ...
    <div style={{ minHeight: '100vh', background: '#f8fafc' }}>
      ...
      <div style={{ maxWidth: 1200, margin: '0 auto', padding: '32px 24px' }}>
        <div style={{ marginBottom: 32 }}>
          <h1 style={{ fontSize: 28, fontWeight: 800, color: '#0f172a', marginBottom: 4 }}>Welcome, {firstName} 🛠️</h1>
          <p style={{ fontSize: 15, color: '#64748b' }}>Find gigs that match your skills — no license required.</p>
        </div>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: 20 }}>
          <div style={{ background: 'white', borderRadius: 14, padding: 32, border: '1px solid #f1f5f9' }}>
            <h3 style={{ fontSize: 18, fontWeight: 700, color: '#0f172a', marginBottom: 16 }}>Available Gigs</h3>
            <div style={{ textAlign: 'center', padding: '24px 0' }}>
              <div style={{ fontSize: 40, marginBottom: 12 }}>🌿</div>
              <p style={{ fontSize: 14, color: '#94a3b8' }}>No gigs available yet. Homeowners are scoping projects — check back soon!</p>
            </div>
          </div>

          <div style={{ background: 'white', borderRadius: 14, padding: 32, border: '1px solid #f1f5f9' }}>
            <h3 style={{ fontSize: 18, fontWeight: 700, color: '#0f172a', marginBottom: 16 }}>My Applications</h3>
            <div style={{ textAlign: 'center', padding: '24px 0' }}>
              <div style={{ fontSize: 40, marginBottom: 12 }}>📨</div>
              <p style={{ fontSize: 14, color: '#94a3b8' }}>No applications yet. Browse available gigs to get started.</p>
            </div>
          </div>
        </div>
      </div>
